...
struct invalid_space final {
    template <typename T = void> invalid_space() {
        static_assert(
            false, "You can't do anything with vectors or points from "
                   "different spaces."
        );
    }
};
...
struct invalid_point_to_vector_addition final {
    template <typename T = void> invalid_point_to_vector_addition() { static_assert(false, "You can't add points to vectors."); }
};
...
struct invalid_normalized_vector_in_place_cross final {
    template <typename T = void> invalid_normalized_vector_in_place_cross() {
        static_assert(
            false, "You can't cross a normalized vector in place with a "
