...
struct std::formatter<Space::implementation::XYVector<S, U>>
    : Space::implementation::baseFormatter<S, Space::implementation::BaseType::XYVector> {

    using _base = Space::implementation::baseFormatter<S, Space::implementation::BaseType::XYVector>;
