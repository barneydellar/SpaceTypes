...
public:
  ...
  friend std::ostream &
  operator<<(std::ostream &os, const XYPoint<ThisSpace, UnderlyingData> &item) {
  ...
  StaticAssert::invalid_vector3_to_xy_point_addition
  operator+=(const Vector<ThisSpace, UnderlyingData> &) noexcept {
  ...
  StaticAssert::invalid_point_to_point_addition
  operator+(const Point<ThisSpace, UnderlyingData> &) const {
    return StaticAssert::invalid_point_to_point_addition{};
  }
  StaticAssert::invalid_point_to_point_addition
  operator+(const XYPoint<ThisSpace, UnderlyingData> &) const {
    return StaticAssert::invalid_point_to_point_addition{};
  }
#endif
